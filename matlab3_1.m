...
plot(DTtime.day_time, DTtime.fukuoka_temp,"r-")
    hold on
plot(DTtime.day_time, DTtime.tokyo_temp,"g-")
    hold on
plot(DTmonth_avr.day_time, DTmonth_avr.fukuoka_temp,"bo")
    hold on
plot(DTmonth_avr.day_time, DTmonth_avr.tokyo_temp,"bsquare")
    hold off
...
xlabel("days")
ylabel("rainfall (mm)")
legend('Fukuoka monthly rain sum','Tokyo monthly rain sum', Location='northwest')
